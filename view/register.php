...
<div class="container">
    ...
    <form>
        <div class="form-group">
            ...
            <input type="text" class="form-control textInput" id="inputUsername" aria-describedby="usernameInfo"
            ...
            <input type="email" class="form-control textInput" id="inputEmail" placeholder="email@gmail.com">
        </div>
